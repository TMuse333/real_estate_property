...
const Property = ({heroImage,price,
 ...
 <p className="open-house-hours"> 
    Open House - {openingDate || 'march 24th 3pm'} - {closingDate || 'march 25th 5pm'}
                 ...
                 <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas et ad, similique nobis molestias ullam alias? Beatae suscipit expedita nobis nulla inventore incidunt eaque molestias ipsum repudiandae reprehenderit. Asperiores, laborum?
                    {mainDescription}
                 </p>
