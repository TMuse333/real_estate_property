...
const ProductCarousel = ({images,horizontal}) => {
  ...
  const handleMouseDown = (e, index) => {
    ...
    const handleMouseMove = (e) => {
        const distanceMoved = e.clientX - initialX;
        const newPosition = currentPosition + distanceMoved;
        
        // Update the position of the image
        // You can set constraints if needed to limit the movement
        // setPositions((prevPositions) =>
        //     prevPositions.map((position, idx) => {
        //         if (idx === index) {
        //             return {
        //                 ...position,
