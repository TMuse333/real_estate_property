...
const ProductCarousel = ({images,horizontal}) => {
  ...
  const handleMouseDown = (index) => {
    ...
    const timeDifference = clickTime - mouseDownTime;

    // If the time difference is less than a threshold (e.g., 200ms),
    // it's considered a click event. Otherwise, it's a mouse hold event.
    if (timeDifference < 200) {
        // Handle click event
        console.log('Clicked!');
    } else {
        // Handle mouse hold event
