...
const CreateText = ({ onSave }) => {
  const [propertyData, setPropertyData] = useState({
    propertyHerobanner: undefined,
    propertyPrice: undefined,
    propertyOpeningDate: undefined,
    propertyClosingDate: undefined,
    propertyMainDescription: undefined,
    propertyDescription2: undefined,
    propertyDescription3: undefined,
    propertyVideo: undefined,
    featureAttributes: undefined, 
    sliderImages: undefined,
    carouselImages1: undefined,
    carouselImages2: undefined,
    documents: undefined,
    factsList: undefined,
    profile: undefined
