...
<>
        ...
        {!isDesktop ? (
           ...
           >
            ...
            <motion.h3
              initial={textVariants(true,2).hidden}
              animate={tiltFinished ? textVariants(true,1).animate : null}>
                Re/max</motion.h3>
            <motion.p
              initial={textVariants(true,2).hidden}
              animate={tiltFinished ? textVariants(true,1).animate : null}
            ...
            <motion.p
              initial={textVariants(true,2).hidden}
              animate={tiltFinished ? textVariants(true,1).animate : null}>REL#1234567890</motion.p>
                </div>
                <motion.img
            //  initial={imgVariants.hidden}
            //  animate={inView? imgVariants.animate : null}
              ...
              <div className="profile-contacts">
                    ...
                    <motion.h2
                      ...
                      animate={tiltFinished ? textVariants(false,2).animate : null}>Contact information</motion.h2>
                    <motion.p
                     initial={textVariants(false,2).hidden}
                     animate={tiltFinished ? textVariants(false,2).animate : null}
