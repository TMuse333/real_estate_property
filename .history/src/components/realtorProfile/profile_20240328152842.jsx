...
<>
        ...
        {!isDesktop ? (
            ...
            animate={inView ? textVariants(true,1).animate : null}>Thomas Musial</motion.h2>
            <motion.h3
              initial={textVariants(true,2).hidden}
              animate={inView ? textVariants(true,1.25).animate : null}>Re/max</motion.h3>
            <motion.p
              initial={textVariants(true,2).hidden}
              animate={inView ? textVariants(true,1.5).animate : null}
            >A real one</motion.p>
            <motion.p
              initial={textVariants(true,2).hidden}
              animate={inView ? textVariants(true,1.75).animate : null}>REL#1234567890</motion.p>
                </div>
                <motion.img
             initial={imgVariants.hidden}
             animate={inView? imgVariants.animate : null}
              ...
              <div className="profile-contacts">
                    ...
                    <motion.h2
                      initial={textVariants(true,2).hidden}
                      animate={inView ? textVariants(true,2).animate : null}>Contact information</motion.h2>
                    <motion.p
                     initial={textVariants(true,2).hidden}
                     animate={inView ? textVariants(true,2).animate : null}
