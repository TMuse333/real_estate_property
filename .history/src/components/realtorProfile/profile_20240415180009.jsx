...
const {profileImage,  setProfileName,
profileName,
profilePosition,
setProfilePosition,
companyName,
...
setProfileEmail,
profilePhoneNumber,
setProfilePhoneNumber} = useProfileContext()

console.log('setProfileName:', setProfileName);
console.log('setProfilePosition:', setProfilePosition);
console.log('setCompanyName:', setCompanyName);
console.log('setProfileEmail:', setProfileEmail);
console.log('setProfilePhoneNumber:', setProfilePhoneNumber);
