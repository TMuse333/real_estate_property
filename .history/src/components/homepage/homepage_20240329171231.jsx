...
import { useRouteContext } from '../../context/RouteContext'; // Import useRouteContext hook

const Homepage = () => {
    const { addNewRoute } = useRouteContext(); // Access addNewRoute function from RouteContext
