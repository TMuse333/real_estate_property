...
const ImageUploader = ({ onSingleImageUpload, onMultipleImagesUpload, multiple, inputName, setterFunction, isProfile }) => {
  ...
  return (
    <>
      <div className={uploaderClassName} onDragOver={handleDragOver} onDrop={handleDrop}>
        ...
        ) : !multiple && droppedImages.length > 0  && !profileImage? (
          <>
