...
const ImageUploader = ({ onSingleImageUpload, onMultipleImagesUpload, multiple }) => {
    const [droppedImages, setDroppedImages] = useState(multiple ? [] : null);
    ...
    const handleDrop = (event) => {
        ...
        } else if (!multiple && onSingleImageUpload) {
            onSingleImageUpload(files[0]);
        }
    };
    ...
    return (
        <div
            ...
            onDrop={handleDrop}
        >
            {droppedImages && droppedImages.map((imageURL, index) => (
