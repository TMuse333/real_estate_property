...
inputName, setterFunction, imageArray }) => {
  ...
  useEffect(() => {
    if (multiple && droppedImages.length > 0 && setterFunction) {
      setterFunction((prevImages) => [...prevImages, droppedImages[droppedImages.length - 1]]);
    } else if (!multiple && droppedImages.length > 0 && setterFunction) {
      setterFunction(droppedImages[droppedImages.length - 1]);
    }
  }, [droppedImages, multiple, setterFunction]);
